...
// load raydetection results from VVDS DEEP and compare results with EZ python EZELMatch results
{
    ...
    TFloat64List rayPosList = UtilLoadDetectedRayPositions("../test/data/RayTestCase/RayMatchingVVDS/sc_020100776_F02P017_vmM1_red_129_1_atm_clean.fits/detectedRayCatalog.csv");
    ...
    TFloat64List zListRef = UtilLoadRayMatchingResults("../test/data/RayTestCase/RayMatchingVVDS/sc_020100776_F02P017_vmM1_red_129_1_atm_clean.fits/rayMatching.csv");
