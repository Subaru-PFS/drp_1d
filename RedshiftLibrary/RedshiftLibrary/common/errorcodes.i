enum class ErrorCode {
  ...
  PDF_PEAK_NOT_FOUND,
  DEPRECTAED__MAX_AT_BORDER_PDF,
  MISSING_PARAMETER,
  BAD_PARAMETER_VALUE,
  UNKNOWN_ATTRIBUTE,
  DEPRECTAED__BAD_LINECATALOG,
  DEPRECTAED__BAD_LOGSAMPLEDSPECTRUM,
  BAD_COUNTMATCH,
  BAD_TEMPLATECATALOG,
  INVALID_SPECTRUM,
  TEMPLATE_OVERLAP_TOO_SMALL,
  IE_DZ_NOT_COMPUTABLE,
  DEPRECTAED__INCOHERENT_INPUTPARAMETERS,
  BAD_CALZETTICORR,
  IE_CRANGE_VALUE_OUTSIDERANGE,
  IE_CRANGE_VECTBORDERS_OUTSIDERANGE,
  IE_CRANGE_NO_INTERSECTION,
  INVALID_MERIT_VALUES,
  DEPRECTAED__TPL_NAME_EMPTY,
  EMPTY_LIST,
  ...
  DEPRECTAED__UNKNOWN_RESULT_TYPE,
