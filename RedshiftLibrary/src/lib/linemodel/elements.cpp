...
CElements::CElements(const CRayCatalog::TRayVector &restRayList):
 ...
 **/
Int32 CElements::GetModelValidElementsNDdl()
{
    Int32 nddl = 0;
 ...
 **/
Int32 CElements::GetModelNonZeroElementsNDdl()
{
    Int32 nddl = 0;
    for( UInt32 iElts=0; iElts<m_Elements.size(); iElts++ )
    {
 ...
 **/
std::vector<UInt32> CElements::GetModelValidElementsIndexes()
{
...
bool CElements::IsElementIndexInDisabledList(Int32 index)
{
...
/**
 * @brief CElements::SetElementIndexesDisabledAuto
 * Disables all the elements that have all sub-elements (lines) amplitudes equal to zero
 */
void CElements::SetElementIndexesDisabledAuto()
{
    for( UInt32 iElts=0; iElts<m_Elements.size(); iElts++ )
    {
        if(m_Elements[iElts]->IsOutsideLambdaRange() == true){
...
void CElements::ResetElementIndexesDisabled()
{
...
**/
std::vector<std::vector<Int32>> CElements::GetModelVelfitGroups( Int32 lineType )
{
    Bool verbose = false;
    if(verbose)
    {
...
std::vector<UInt32> CElements::getOverlappingElements(UInt32 ind, const std::vector<UInt32> & excludedInd,Float64 redshift,Float64 overlapThres)
{
 ...
 **/
void CElements::SetElementAmplitude(Int32 j, Float64 a, Float64 snr)
{
 ...
 **/
Float64 CElements::GetElementAmplitude(Int32 j)
{
    Float64 a=-1.0;
    if(j>=0 && j<m_Elements.size())
    {
...
void CElements::SetSourcesizeDispersion(Float64 sizeArcsec)
{
 ...
 **/
Int32 CElements::FindElementIndex(Int32 LineCatalogIndex)
{
    Int32 idx = -1;
    for( UInt32 iElts=0; iElts<m_Elements.size(); iElts++ )
    {
 ...
 **/
Int32 CElements::FindElementIndex(std::string LineTagStr, Int32 linetype, Int32& lineIdx )
{
    Int32 idx = -1;
    for( UInt32 iElts=0; iElts<m_Elements.size(); iElts++ )
    {
 ...
 **/
Float64 CElements::getModelErrorUnderElement( UInt32 eltId ,
 ...
 **/
std::vector<UInt32> CElements::getSupportIndexes( const std::vector<UInt32> & EltsIdx )
{
    std::vector<UInt32> indexes;
...
Int32 CElements::getIndexAmpOffset(UInt32 xIndex)
{
...
void CElements::setAmplitudeOffsetsCoeffsAt(UInt32 index,Float64 x0,Float64 x1,Float64 x2)
{
...
Bool CElements::addToSpectrumAmplitudeOffset(const CSpectrumSpectralAxis& spectralAxis, CSpectrumFluxAxis& modelfluxAxis )
{
...
Int32 CElements::prepareAmplitudeOffset(const CSpectrumFluxAxis& spcFlux)
{
