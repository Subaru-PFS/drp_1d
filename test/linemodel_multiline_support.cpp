...
{
    //some input params
    std::string spectrumPath = spcPath;//"../test/data/LinemodelProfileTestCase/signalnoise_4lines_sig400_6000A_10000A.fits";       //unused, only needed for linemodel initialization
    std::string noisePath    = nPath;//"../test/data/LinemodelProfileTestCase/noise_4lines_sig400_6000A_10000A.fits";     //unused, only needed for linemodel initialization
...
{
    std::string linecatalogPath = "../test/data/LinemodelSupportTestCase/linecatalog_test_linemodel_support_1EL_15000.txt";

    std::string spectrumPath = "../test/data/LinemodelSupportTestCase/spc_100_114181174_axespc_F.fits";
    std::string noisePath    = "../test/data/LinemodelSupportTestCase/spc_100_114181174_axespc_ErrF.fits";
...
{
    std::string linecatalogPath = "../test/data/LinemodelSupportTestCase/linecatalog_test_linemodel_support_1EL_OIIIb.txt";
