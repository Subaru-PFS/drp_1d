...
Bool CDTreeBSolveResult::GetBestRedshift( const COperatorResultStore& store, Float64& redshift, Float64& merit ) const
{
    ...
    for( Int32 iE=0; iE<nExtrema; iE++ )
    {
        ...
        Float64 firstz = results->Extrema[0];
...
Bool CDTreeBSolveResult::GetBestRedshiftChi2( const COperatorResultStore& store, std::string scopeStr, Float64 targetz, Float64& redshift, Float64& merit, std::string& tplName ) const
{
