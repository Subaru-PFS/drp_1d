...
private:
    ...
    Void BasicFit(const CSpectrum& spectrum, const CTemplate& tpl, Float64 *pfgTplBuffer,
                   ...
                   Float64& overlapRate, Float64& chiSquare, Float64 &fittingAmplitude, EStatus& status, std::string opt_interp, Float64 forcedAmplitude=-1, Int32 opt_extinction=0, CMask spcMaskAdditional=CMask() );
